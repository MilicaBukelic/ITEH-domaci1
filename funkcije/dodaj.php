<?php
    ...
    if(isset($_POST["sifra"]) && isset($_POST["polazak"]) && isset($_POST["dolazak"]) &&
       isset($_POST["aviokompanija"]) && isset($_POST["datum"]) && isset($_POST["sati"]) && isset($_POST["minuti"])){
        ...
        $rez = Let::DodajLet($conn,$let);

        if($rez == TRUE){
            echo ("Uspesno ste izvrsili rezervaciju.");
            die();
        }
        else{
            echo $rez;
            echo ("Niste izvrsili rezervaciju.");
        }
    }
?>